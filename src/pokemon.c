...
static const enum NationalDexOrder sHoennToNationalOrder[HOENN_DEX_COUNT] =
{
    HOENN_TO_NATIONAL(TRONKNYDE),
    HOENN_TO_NATIONAL(ABRAKNYDE),
    HOENN_TO_NATIONAL(ABRAKLEUR),
    HOENN_TO_NATIONAL(TIFOUX),
    HOENN_TO_NATIONAL(ROUQUETTE),
    HOENN_TO_NATIONAL(CRACHEFOUX),
    HOENN_TO_NATIONAL(TITARDO),
    HOENN_TO_NATIONAL(CRAPODO),
    HOENN_TO_NATIONAL(GRENN),
    HOENN_TO_NATIONAL(SOUSOURIS),
    HOENN_TO_NATIONAL(MILIRAT),
    HOENN_TO_NATIONAL(BOUFTON),
    HOENN_TO_NATIONAL(BOUFTOU),
    HOENN_TO_NATIONAL(CDG_BOUFTOU),
    HOENN_TO_NATIONAL(BOUFTOU_ROYAL),
    HOENN_TO_NATIONAL(GARDIENNE_CHAMPETRE),
    HOENN_TO_NATIONAL(TOURNESOL_SAUVAGE),
    HOENN_TO_NATIONAL(TOURNESOL_AFFAME),
    HOENN_TO_NATIONAL(LARVE_JAUNE),
    HOENN_TO_NATIONAL(LARVE_CHAMPETRE),
    HOENN_TO_NATIONAL(SHIN_LARVE),
    HOENN_TO_NATIONAL(DISCIPLE_DU_KIMBO),
    HOENN_TO_NATIONAL(BITOUF_PLAINE),
    HOENN_TO_NATIONAL(BITOUF_AERIEN),
    HOENN_TO_NATIONAL(LA_FOLLE),
    HOENN_TO_NATIONAL(LA_BLOQUEUSE),
    HOENN_TO_NATIONAL(TOFU),
    HOENN_TO_NATIONAL(GWO_TOFU),
    HOENN_TO_NATIONAL(TOFU_ROYAL),
    HOENN_TO_NATIONAL(BWAK_GLACE),
    HOENN_TO_NATIONAL(KWAKERE_GLACE),
    HOENN_TO_NATIONAL(BWAK_VENT),
    HOENN_TO_NATIONAL(KWAKERE_VENT),
    HOENN_TO_NATIONAL(BWAK_FEU),
    HOENN_TO_NATIONAL(KWAKERE_FEU),
    HOENN_TO_NATIONAL(BWAK_TERRE),
    HOENN_TO_NATIONAL(KWAKERE_TERRE),
    HOENN_TO_NATIONAL(TIGRIMAS),
    HOENN_TO_NATIONAL(RONRONCHON),
    HOENN_TO_NATIONAL(ARAKNE),
    HOENN_TO_NATIONAL(ARAKNOTRON),
    HOENN_TO_NATIONAL(ABRAKNE),
    HOENN_TO_NATIONAL(MOSKITO),
    HOENN_TO_NATIONAL(MINOSKITO),
    HOENN_TO_NATIONAL(CHAMP_CHAMP),
    HOENN_TO_NATIONAL(CHAMP_A_GNON),
    HOENN_TO_NATIONAL(MARCACIN),
    HOENN_TO_NATIONAL(SANGLIER),
    HOENN_TO_NATIONAL(SANGLIER_AGRESSIF),
    HOENN_TO_NATIONAL(EL_SCARADOR),
    HOENN_TO_NATIONAL(SCARAFEUILLE_VERT),
    HOENN_TO_NATIONAL(SCARAFEUILLE_BLEU),
    HOENN_TO_NATIONAL(SCARAFEUILLE_BLANC),
    HOENN_TO_NATIONAL(SCARAFEUILLE_ROUGE),
    HOENN_TO_NATIONAL(SCARAFEUILLE_NOIR),
    HOENN_TO_NATIONAL(SCARABOSSE_DORE),
    HOENN_TO_NATIONAL(TIWABBIT),
    HOENN_TO_NATIONAL(WABBIT),
    HOENN_TO_NATIONAL(WO_WABBIT),
    HOENN_TO_NATIONAL(GOBET),
    HOENN_TO_NATIONAL(GOB_TROTTEUR),
    HOENN_TO_NATIONAL(SHERPOA),
    HOENN_TO_NATIONAL(LAPINO),
    HOENN_TO_NATIONAL(LAPINO_MUTANT),
    HOENN_TO_NATIONAL(GOBGOB),
    HOENN_TO_NATIONAL(GOBGOB_GLOUTON),
    HOENN_TO_NATIONAL(PHORREVEUR),
    HOENN_TO_NATIONAL(METAPHORREUR),
    HOENN_TO_NATIONAL(PHOSSILE),
    HOENN_TO_NATIONAL(RAPHAELA),
    HOENN_TO_NATIONAL(TORTUE_BLEU),
    HOENN_TO_NATIONAL(DOLBINOS),
    HOENN_TO_NATIONAL(DOKACHU),
    HOENN_TO_NATIONAL(KITSOU),
    HOENN_TO_NATIONAL(BOURGEON),
    HOENN_TO_NATIONAL(BULBISAUGE),
    HOENN_TO_NATIONAL(SARKAPWANE),
    HOENN_TO_NATIONAL(SERPENTIN),
    HOENN_TO_NATIONAL(SERPIPLUME),
    HOENN_TO_NATIONAL(DAGON),
    HOENN_TO_NATIONAL(PICHON),
    HOENN_TO_NATIONAL(RAUL_MOPS),
    HOENN_TO_NATIONAL(TIMANSOT),
    HOENN_TO_NATIONAL(MANSOBESE),
    HOENN_TO_NATIONAL(MAMANSOT),
    HOENN_TO_NATIONAL(FU_MANSOT),
    HOENN_TO_NATIONAL(MOFETTE),
    HOENN_TO_NATIONAL(OBSIDIANTRE),
    HOENN_TO_NATIONAL(CRAPEUR),
    HOENN_TO_NATIONAL(MOUCHAME),
    HOENN_TO_NATIONAL(MORFRELON),
    HOENN_TO_NATIONAL(VOLKORNE),
    HOENN_TO_NATIONAL(VORACLE),
    HOENN_TO_NATIONAL(COCHON_DE_FARLE),
    HOENN_TO_NATIONAL(DRAGON_COCHON),
    HOENN_TO_NATIONAL(SCORPIQUE),
    HOENN_TO_NATIONAL(SCORDION),
    HOENN_TO_NATIONAL(GAMINO),
    HOENN_TO_NATIONAL(MINOTOT),
    HOENN_TO_NATIONAL(OUROBOULOS),
    HOENN_TO_NATIONAL(MANTISCORE),
    HOENN_TO_NATIONAL(PAMPACTUS),
    HOENN_TO_NATIONAL(CACTOBLONGO),
    HOENN_TO_NATIONAL(CHIENCHIEN_ENRAGE),
    HOENN_TO_NATIONAL(LEOLHYENE),
    HOENN_TO_NATIONAL(SKYBOUFTON),
    HOENN_TO_NATIONAL(SKYBOUFTOU),
    HOENN_TO_NATIONAL(DIEUBOUFTOU),
    HOENN_TO_NATIONAL(CHIENCHIEN_NOIR),
    HOENN_TO_NATIONAL(MULOUBARD),
    HOENN_TO_NATIONAL(ECUROUILLE),
    HOENN_TO_NATIONAL(PRESPIC),
    HOENN_TO_NATIONAL(CHACHA),
    HOENN_TO_NATIONAL(CHAGOUAR),
    HOENN_TO_NATIONAL(SOLDALIA),
    HOENN_TO_NATIONAL(COQUELICOGNE),
    HOENN_TO_NATIONAL(CAMELIACHE),
    HOENN_TO_NATIONAL(GROKILLAGE),
    HOENN_TO_NATIONAL(MOUMOULE),
    HOENN_TO_NATIONAL(CRAQUELOPE),
    HOENN_TO_NATIONAL(CRAQUEBOULE),
    HOENN_TO_NATIONAL(CRAQUELEUR),
    HOENN_TO_NATIONAL(GERMINION),
    HOENN_TO_NATIONAL(GANGREDOGUE),
    HOENN_TO_NATIONAL(BEBE_CROCOBURIO),
    HOENN_TO_NATIONAL(CROCODAILLE),
    HOENN_TO_NATIONAL(CROCOBURIO),
    HOENN_TO_NATIONAL(OUASSINGUE),
    HOENN_TO_NATIONAL(BOURBASSINGUE),
    HOENN_TO_NATIONAL(ROISSINGUE),
    HOENN_TO_NATIONAL(DRAGODINDE),
    HOENN_TO_NATIONAL(BIBLOP),
    HOENN_TO_NATIONAL(BLOP),
    HOENN_TO_NATIONAL(GLOUTOBLOP),
    HOENN_TO_NATIONAL(KOALAK_IMMATURE),
    HOENN_TO_NATIONAL(KOALAK_INDIGO),
    HOENN_TO_NATIONAL(CRASPER),
    HOENN_TO_NATIONAL(FANTOMAYTE),
    HOENN_TO_NATIONAL(VIGIE_PIRATE),
    HOENN_TO_NATIONAL(TOFU_MALEFIQUE),
    HOENN_TO_NATIONAL(KARNHELL),
    HOENN_TO_NATIONAL(KWOAN),
    HOENN_TO_NATIONAL(CHAFER),
    HOENN_TO_NATIONAL(NODKOKO),
    HOENN_TO_NATIONAL(TIKOKO),
    HOENN_TO_NATIONAL(GROKOKO),
    HOENN_TO_NATIONAL(KOKULTE),
    HOENN_TO_NATIONAL(KASKARGO),
    HOENN_TO_NATIONAL(NERBE),
    HOENN_TO_NATIONAL(FECORCE),
    HOENN_TO_NATIONAL(MINIKRONE),
    HOENN_TO_NATIONAL(RAINIKRONE),
    HOENN_TO_NATIONAL(MALEPIK),
    HOENN_TO_NATIONAL(MALTRIO),
    HOENN_TO_NATIONAL(CORBAC),
    HOENN_TO_NATIONAL(CAAPSALOOCKE),
    HOENN_TO_NATIONAL(MAITRE_CORBAC),
    HOENN_TO_NATIONAL(KANIGLOUPS),
    HOENN_TO_NATIONAL(KANIGLOU),
    HOENN_TO_NATIONAL(BISOUGLOURS),
    HOENN_TO_NATIONAL(GLOURAGAN),
    HOENN_TO_NATIONAL(BLERODOUDOU),
    HOENN_TO_NATIONAL(WOLVERO),
    HOENN_TO_NATIONAL(BLEROM),
    HOENN_TO_NATIONAL(TILAMPROIE),
    HOENN_TO_NATIONAL(MANTAZE),
    HOENN_TO_NATIONAL(MULDO),
    HOENN_TO_NATIONAL(CORAILLEUR),
    HOENN_TO_NATIONAL(MOL_USK),
    HOENN_TO_NATIONAL(DEMOLOCH),
    HOENN_TO_NATIONAL(DIABELIAL),
    HOENN_TO_NATIONAL(TYPHOMET),
    HOENN_TO_NATIONAL(HALBARDENT),
    HOENN_TO_NATIONAL(KLEMOR),
    HOENN_TO_NATIONAL(DRAGOUNE),
    HOENN_TO_NATIONAL(DRAGONNET),
    HOENN_TO_NATIONAL(CROCABULIA),
    HOENN_TO_NATIONAL(SINISTROFU),
    HOENN_TO_NATIONAL(NOCTURLABE),
    HOENN_TO_NATIONAL(GRANDUK),
};
