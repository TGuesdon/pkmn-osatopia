...
enum NationalDexOrder
{
    ...
    //Dofus
    NATIONAL_DEX_TRONKNYDE,
    NATIONAL_DEX_ABRAKNYDE,
    NATIONAL_DEX_ABRAKLEUR,
    NATIONAL_DEX_TIFOUX,
    NATIONAL_DEX_ROUQUETTE,
    NATIONAL_DEX_CRACHEFOUX,
    NATIONAL_DEX_TITARDO,
    NATIONAL_DEX_CRAPODO,
    NATIONAL_DEX_GRENN,
    NATIONAL_DEX_SOUSOURIS,
    NATIONAL_DEX_MILIRAT,
    NATIONAL_DEX_BOUFTON,
    NATIONAL_DEX_BOUFTOU,
    NATIONAL_DEX_CDG_BOUFTOU,
    NATIONAL_DEX_BOUFTOU_ROYAL,
    NATIONAL_DEX_GARDIENNE_CHAMPETRE,
    NATIONAL_DEX_TOURNESOL_SAUVAGE,
    NATIONAL_DEX_TOURNESOL_AFFAME,
    NATIONAL_DEX_LARVE_JAUNE,
    NATIONAL_DEX_LARVE_CHAMPETRE,
    NATIONAL_DEX_SHIN_LARVE,
    NATIONAL_DEX_DISCIPLE_DU_KIMBO,
    NATIONAL_DEX_BITOUF_PLAINE,
    NATIONAL_DEX_BITOUF_AERIEN,
    NATIONAL_DEX_LA_FOLLE,
    NATIONAL_DEX_LA_BLOQUEUSE,
    NATIONAL_DEX_TOFU,
    NATIONAL_DEX_GWO_TOFU,
    NATIONAL_DEX_TOFU_ROYAL,
    NATIONAL_DEX_BWAK_GLACE,
    NATIONAL_DEX_KWAKERE_GLACE,
    NATIONAL_DEX_BWAK_VENT,
    NATIONAL_DEX_KWAKERE_VENT,
    NATIONAL_DEX_BWAK_FEU,
    NATIONAL_DEX_KWAKERE_FEU,
    NATIONAL_DEX_BWAK_TERRE,
    NATIONAL_DEX_KWAKERE_TERRE,
    NATIONAL_DEX_TIGRIMAS,
    NATIONAL_DEX_RONRONCHON,
    NATIONAL_DEX_ARAKNE,
    NATIONAL_DEX_ARAKNOTRON,
    NATIONAL_DEX_ABRAKNE,
    NATIONAL_DEX_MOSKITO,
    NATIONAL_DEX_MINOSKITO,
    NATIONAL_DEX_CHAMP_CHAMP,
    NATIONAL_DEX_CHAMP_A_GNON,
    NATIONAL_DEX_MARCACIN,
    NATIONAL_DEX_SANGLIER,
    NATIONAL_DEX_SANGLIER_AGRESSIF,
    NATIONAL_DEX_EL_SCARADOR,
    NATIONAL_DEX_SCARAFEUILLE_VERT,
    NATIONAL_DEX_SCARAFEUILLE_BLEU,
    NATIONAL_DEX_SCARAFEUILLE_BLANC,
    NATIONAL_DEX_SCARAFEUILLE_ROUGE,
    NATIONAL_DEX_SCARAFEUILLE_NOIR,
    NATIONAL_DEX_SCARABOSSE_DORE,
    NATIONAL_DEX_TIWABBIT,
    NATIONAL_DEX_WABBIT,
    NATIONAL_DEX_WO_WABBIT,
    NATIONAL_DEX_GOBET,
    NATIONAL_DEX_GOB_TROTTEUR,
    NATIONAL_DEX_SHERPOA,
    NATIONAL_DEX_LAPINO,
    NATIONAL_DEX_LAPINO_MUTANT,
    NATIONAL_DEX_GOBGOB,
    NATIONAL_DEX_GOBGOB_GLOUTON,
    NATIONAL_DEX_PHORREVEUR,
    NATIONAL_DEX_METAPHORREUR,
    NATIONAL_DEX_PHOSSILE,
    NATIONAL_DEX_RAPHAELA,
    NATIONAL_DEX_TORTUE_BLEU,
    NATIONAL_DEX_DOLBINOS,
    NATIONAL_DEX_DOKACHU,
    NATIONAL_DEX_KITSOU,
    NATIONAL_DEX_BOURGEON,
    NATIONAL_DEX_BULBISAUGE,
    NATIONAL_DEX_SARKAPWANE,
    NATIONAL_DEX_SERPENTIN,
    NATIONAL_DEX_SERPIPLUME,
    NATIONAL_DEX_DAGON,
    NATIONAL_DEX_PICHON,
    NATIONAL_DEX_RAUL_MOPS,
    NATIONAL_DEX_TIMANSOT,
    NATIONAL_DEX_MANSOBESE,
    NATIONAL_DEX_MAMANSOT,
    NATIONAL_DEX_FU_MANSOT,
    NATIONAL_DEX_MOFETTE,
    NATIONAL_DEX_OBSIDIANTRE,
    NATIONAL_DEX_CRAPEUR,
    NATIONAL_DEX_MOUCHAME,
    NATIONAL_DEX_MORFRELON,
    NATIONAL_DEX_VOLKORNE,
    NATIONAL_DEX_VORACLE,
    NATIONAL_DEX_COCHON_DE_FARLE,
    NATIONAL_DEX_DRAGON_COCHON,
    NATIONAL_DEX_SCORPIQUE,
    NATIONAL_DEX_SCORDION,
    NATIONAL_DEX_GAMINO,
    NATIONAL_DEX_MINOTOT,
    NATIONAL_DEX_OUROBOULOS,
    NATIONAL_DEX_MANTISCORE,
    NATIONAL_DEX_PAMPACTUS,
    NATIONAL_DEX_CACTOBLONGO,
    NATIONAL_DEX_CHIENCHIEN_ENRAGE,
    NATIONAL_DEX_LEOLHYENE,
    NATIONAL_DEX_SKYBOUFTON,
    NATIONAL_DEX_SKYBOUFTOU,
    NATIONAL_DEX_DIEUBOUFTOU,
    NATIONAL_DEX_CHIENCHIEN_NOIR,
    NATIONAL_DEX_MULOUBARD,
    NATIONAL_DEX_ECUROUILLE,
    NATIONAL_DEX_PRESPIC,
    NATIONAL_DEX_CHACHA,
    NATIONAL_DEX_CHAGOUAR,
    NATIONAL_DEX_SOLDALIA,
    NATIONAL_DEX_COQUELICOGNE,
    NATIONAL_DEX_CAMELIACHE,
    NATIONAL_DEX_GROKILLAGE,
    NATIONAL_DEX_MOUMOULE,
    NATIONAL_DEX_CRAQUELOPE,
    NATIONAL_DEX_CRAQUEBOULE,
    NATIONAL_DEX_CRAQUELEUR,
    NATIONAL_DEX_GERMINION,
    NATIONAL_DEX_GANGREDOGUE,
    NATIONAL_DEX_BEBE_CROCOBURIO,
    NATIONAL_DEX_CROCODAILLE,
    NATIONAL_DEX_CROCOBURIO,
    NATIONAL_DEX_OUASSINGUE,
    NATIONAL_DEX_BOURBASSINGUE,
    NATIONAL_DEX_ROISSINGUE,
    NATIONAL_DEX_DRAGODINDE,
    NATIONAL_DEX_BIBLOP,
    NATIONAL_DEX_BLOP,
    NATIONAL_DEX_GLOUTOBLOP,
    NATIONAL_DEX_KOALAK_IMMATURE,
    NATIONAL_DEX_KOALAK_INDIGO,
    NATIONAL_DEX_CRASPER,
    NATIONAL_DEX_FANTOMAYTE,
    NATIONAL_DEX_VIGIE_PIRATE,
    NATIONAL_DEX_TOFU_MALEFIQUE,
    NATIONAL_DEX_KARNHELL,
    NATIONAL_DEX_KWOAN,
    NATIONAL_DEX_CHAFER,
    NATIONAL_DEX_NODKOKO,
    NATIONAL_DEX_TIKOKO,
    NATIONAL_DEX_GROKOKO,
    NATIONAL_DEX_KOKULTE,
    NATIONAL_DEX_KASKARGO,
    NATIONAL_DEX_NERBE,
    NATIONAL_DEX_FECORCE,
    NATIONAL_DEX_MINIKRONE,
    NATIONAL_DEX_RAINIKRONE,
    NATIONAL_DEX_MALEPIK,
    NATIONAL_DEX_MALTRIO,
    NATIONAL_DEX_CORBAC,
    NATIONAL_DEX_CAAPSALOOCKE,
    NATIONAL_DEX_MAITRE_CORBAC,
    NATIONAL_DEX_KANIGLOUPS,
    NATIONAL_DEX_KANIGLOU,
    NATIONAL_DEX_BISOUGLOURS,
    NATIONAL_DEX_GLOURAGAN,
    NATIONAL_DEX_BLERODOUDOU,
    NATIONAL_DEX_WOLVERO,
    NATIONAL_DEX_BLEROM,
    NATIONAL_DEX_TILAMPROIE,
    NATIONAL_DEX_MANTAZE,
    NATIONAL_DEX_MULDO,
    NATIONAL_DEX_CORAILLEUR,
    NATIONAL_DEX_MOL_USK,
    NATIONAL_DEX_DEMOLOCH,
    NATIONAL_DEX_DIABELIAL,
    NATIONAL_DEX_TYPHOMET,
    NATIONAL_DEX_HALBARDENT,
    NATIONAL_DEX_KLEMOR,
    NATIONAL_DEX_DRAGOUNE,
    NATIONAL_DEX_DRAGONNET,
    NATIONAL_DEX_CROCABULIA,
    NATIONAL_DEX_SINISTROFU,
    NATIONAL_DEX_NOCTURLABE,
    NATIONAL_DEX_GRANDUK,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_GRANDUK
...
enum HoennDexOrder
{
    ...
    HOENN_DEX_BOUFTON,
    HOENN_DEX_BOUFTOU,
    HOENN_DEX_CDG_BOUFTOU,
    HOENN_DEX_BOUFTOU_ROYAL,
    HOENN_DEX_GARDIENNE_CHAMPETRE,
    HOENN_DEX_TOURNESOL_SAUVAGE,
    HOENN_DEX_TOURNESOL_AFFAME,
    HOENN_DEX_LARVE_JAUNE,
    HOENN_DEX_LARVE_CHAMPETRE,
    HOENN_DEX_SHIN_LARVE,
    HOENN_DEX_DISCIPLE_DU_KIMBO,
    HOENN_DEX_BITOUF_PLAINE,
    HOENN_DEX_BITOUF_AERIEN,
    HOENN_DEX_LA_FOLLE,
    HOENN_DEX_LA_BLOQUEUSE,
    HOENN_DEX_TOFU,
    HOENN_DEX_GWO_TOFU,
    HOENN_DEX_TOFU_ROYAL,
    HOENN_DEX_BWAK_GLACE,
    HOENN_DEX_KWAKERE_GLACE,
    HOENN_DEX_BWAK_VENT,
    HOENN_DEX_KWAKERE_VENT,
    HOENN_DEX_BWAK_FEU,
    HOENN_DEX_KWAKERE_FEU,
    HOENN_DEX_BWAK_TERRE,
    HOENN_DEX_KWAKERE_TERRE,
    HOENN_DEX_TIGRIMAS,
    HOENN_DEX_RONRONCHON,
    HOENN_DEX_ARAKNE,
    HOENN_DEX_ARAKNOTRON,
    HOENN_DEX_ABRAKNE,
    HOENN_DEX_MOSKITO,
    HOENN_DEX_MINOSKITO,
    HOENN_DEX_CHAMP_CHAMP,
    HOENN_DEX_CHAMP_A_GNON,
    HOENN_DEX_MARCACIN,
    HOENN_DEX_SANGLIER,
    HOENN_DEX_SANGLIER_AGRESSIF,
    HOENN_DEX_EL_SCARADOR,
    HOENN_DEX_SCARAFEUILLE_VERT,
    HOENN_DEX_SCARAFEUILLE_BLEU,
    HOENN_DEX_SCARAFEUILLE_BLANC,
    HOENN_DEX_SCARAFEUILLE_ROUGE,
    HOENN_DEX_SCARAFEUILLE_NOIR,
    HOENN_DEX_SCARABOSSE_DORE,
    HOENN_DEX_TIWABBIT,
    HOENN_DEX_WABBIT,
    HOENN_DEX_WO_WABBIT,
    HOENN_DEX_GOBET,
    HOENN_DEX_GOB_TROTTEUR,
    HOENN_DEX_SHERPOA,
    HOENN_DEX_LAPINO,
    HOENN_DEX_LAPINO_MUTANT,
    HOENN_DEX_GOBGOB,
    HOENN_DEX_GOBGOB_GLOUTON,
    HOENN_DEX_PHORREVEUR,
    HOENN_DEX_METAPHORREUR,
    HOENN_DEX_PHOSSILE,
    HOENN_DEX_RAPHAELA,
    HOENN_DEX_TORTUE_BLEU,
    HOENN_DEX_DOLBINOS,
    HOENN_DEX_DOKACHU,
    HOENN_DEX_KITSOU,
    HOENN_DEX_BOURGEON,
    HOENN_DEX_BULBISAUGE,
    HOENN_DEX_SARKAPWANE,
    HOENN_DEX_SERPENTIN,
    HOENN_DEX_SERPIPLUME,
    HOENN_DEX_DAGON,
    HOENN_DEX_PICHON,
    HOENN_DEX_RAUL_MOPS,
    HOENN_DEX_TIMANSOT,
    ...
    HOENN_DEX_FU_MANSOT,
    HOENN_DEX_MOFETTE,
    HOENN_DEX_OBSIDIANTRE,
    HOENN_DEX_CRAPEUR,
    HOENN_DEX_MOUCHAME,
    HOENN_DEX_MORFRELON,
    HOENN_DEX_VOLKORNE,
    HOENN_DEX_VORACLE,
    HOENN_DEX_COCHON_DE_FARLE,
    HOENN_DEX_DRAGON_COCHON,
    HOENN_DEX_SCORPIQUE,
    HOENN_DEX_SCORDION,
    HOENN_DEX_GAMINO,
    HOENN_DEX_MINOTOT,
    HOENN_DEX_OUROBOULOS,
    HOENN_DEX_MANTISCORE,
    HOENN_DEX_PAMPACTUS,
    HOENN_DEX_CACTOBLONGO,
    HOENN_DEX_CHIENCHIEN_ENRAGE,
    HOENN_DEX_LEOLHYENE,
    HOENN_DEX_SKYBOUFTON,
    HOENN_DEX_SKYBOUFTOU,
    HOENN_DEX_DIEUBOUFTOU,
    HOENN_DEX_CHIENCHIEN_NOIR,
    HOENN_DEX_MULOUBARD,
    HOENN_DEX_ECUROUILLE,
    HOENN_DEX_PRESPIC,
    HOENN_DEX_CHACHA,
    HOENN_DEX_CHAGOUAR,
    HOENN_DEX_SOLDALIA,
    HOENN_DEX_COQUELICOGNE,
    HOENN_DEX_CAMELIACHE,
    HOENN_DEX_GROKILLAGE,
    HOENN_DEX_MOUMOULE,
    HOENN_DEX_CRAQUELOPE,
    HOENN_DEX_CRAQUEBOULE,
    HOENN_DEX_CRAQUELEUR,
    HOENN_DEX_GERMINION,
    HOENN_DEX_GANGREDOGUE,
    HOENN_DEX_BEBE_CROCOBURIO,
    HOENN_DEX_CROCODAILLE,
    HOENN_DEX_CROCOBURIO,
    HOENN_DEX_OUASSINGUE,
    HOENN_DEX_BOURBASSINGUE,
    HOENN_DEX_ROISSINGUE,
    HOENN_DEX_DRAGODINDE,
    HOENN_DEX_BIBLOP,
    HOENN_DEX_BLOP,
    HOENN_DEX_GLOUTOBLOP,
    HOENN_DEX_KOALAK_IMMATURE,
    HOENN_DEX_KOALAK_INDIGO,
    HOENN_DEX_CRASPER,
    HOENN_DEX_FANTOMAYTE,
    HOENN_DEX_VIGIE_PIRATE,
    HOENN_DEX_TOFU_MALEFIQUE,
    HOENN_DEX_KARNHELL,
    HOENN_DEX_KWOAN,
    HOENN_DEX_CHAFER,
    HOENN_DEX_NODKOKO,
    ...
    HOENN_DEX_FECORCE,
    HOENN_DEX_MINIKRONE,
    HOENN_DEX_RAINIKRONE,
    HOENN_DEX_MALEPIK,
    HOENN_DEX_MALTRIO,
    HOENN_DEX_CORBAC,
    HOENN_DEX_CAAPSALOOCKE,
    HOENN_DEX_MAITRE_CORBAC,
    HOENN_DEX_KANIGLOUPS,
    HOENN_DEX_KANIGLOU,
    HOENN_DEX_BISOUGLOURS,
    HOENN_DEX_GLOURAGAN,
    HOENN_DEX_BLERODOUDOU,
    HOENN_DEX_WOLVERO,
    HOENN_DEX_BLEROM,
    HOENN_DEX_TILAMPROIE,
    HOENN_DEX_MANTAZE,
    HOENN_DEX_MULDO,
    HOENN_DEX_CORAILLEUR,
    HOENN_DEX_MOL_USK,
    HOENN_DEX_DEMOLOCH,
    HOENN_DEX_DIABELIAL,
    HOENN_DEX_TYPHOMET,
    HOENN_DEX_HALBARDENT,
    HOENN_DEX_KLEMOR,
    HOENN_DEX_DRAGOUNE,
    HOENN_DEX_DRAGONNET,
    HOENN_DEX_CROCABULIA,
    HOENN_DEX_SINISTROFU,
    HOENN_DEX_NOCTURLABE,
    HOENN_DEX_GRANDUK,
};

#define HOENN_DEX_COUNT (HOENN_DEX_GRANDUK + 1)
